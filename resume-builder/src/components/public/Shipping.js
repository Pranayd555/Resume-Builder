...
import { ArrowLeftIcon, TruckIcon, ClockIcon, CheckCircleIcon, ExclamationTriangleIcon } from '@heroicons/react/24/outline';
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-12">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Available Formats</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center p-4 bg-white dark:bg-gray-700 rounded-xl">
                  <div className="text-2xl mb-2">📄</div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">PDF</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">High-quality, print-ready format</p>
                </div>
                <div className="text-center p-4 bg-white dark:bg-gray-700 rounded-xl">
                  <div className="text-2xl mb-2">📝</div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">DOCX</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Editable Microsoft Word format</p>
                </div>
                <div className="text-center p-4 bg-white dark:bg-gray-700 rounded-xl">
                  <div className="text-2xl mb-2">🌐</div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">HTML</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Web-friendly format</p>
                </div>
              </div>
              
              <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Download Process</h4>
          ...
          <section className="mb-12">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Your Data is Safe</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">Storage Features</h4>
                  <ul className="space-y-2 text-gray-600 dark:text-gray-300">
                    <li className="flex items-start gap-2">
                      <CheckCircleIcon className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
          ...
          <section className="mb-12">
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/20 rounded-2xl p-6">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Uptime Commitment</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              <div className="mt-6 p-4 bg-white dark:bg-gray-800 rounded-xl">
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Maintenance Notices</h4>
                <p className="text-gray-600 dark:text-gray-300">
