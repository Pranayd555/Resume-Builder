    ...
    const templates = [
...

      {
        ...
        templateCode: {
          ...
          .achievements { margin-bottom: 0.25rem; padding-left: 12px; }
...

      {
        ...
        templateCode: {
          ...
          .achievements { margin-bottom: 0.25rem; padding-left: 0.6rem; }
      ...
      // CREATIVE CATEGORY
      {
        ...
        templateCode: {
          ...
          .achievements { margin: 2px 0; padding-left: 16px; }
      ...
      // MINIMALIST CATEGORY
      {
        ...
        templateCode: {
          ...
          .achievements { margin: 2px 0; padding-left: 12px; }
      ...
      // PROFESSIONAL CATEGORY
      {
        ...
        templateCode: {
          ...
          .description { margin-bottom: 0.25rem; color: #4b5563; line-height: 1; }
          .achievements { margin: 2px 0; padding-left: 10px; }
...

      {
        ...
        templateCode: {
          html: `<div class="resume professional-executive">
            ...
            {{#if projects}}<section class="executive-projects"><h2>KEY INITIATIVES & PROJECTS</h2>{{#each projects}}<div class="project-item"><h3>{{name}}</h3>{{#if description}}<p class="project-description">{{description}}</p>{{/if}}{{#if technologies}}<div class="project-technologies"><div class="tech-label">Technologies/Methods:</div> {{#each technologies}}{{this}}{{#unless @last}}, {{/unless}}{{/each}}</div>{{/if}}{{#if url}}<div class="project-links"><a href="{{url}}" target="_blank">View Project</a></div>{{/if}}{{#if githubUrl}}<div class="project-links"><a href="{{githubUrl}}" target="_blank">Repository</a></div>{{/if}}</div>{{/each}}</section>{{/if}}
...

      {
        ...
        templateCode: {
          ...
          .achievements { margin: 4px 0; padding-left: 16px; }
          .achievements li { margin-bottom: 2px; color: #4b5563; }
