module.exports = [
    {
...

      {
        ...
        templateCode: {
          ...
          .contact-item a { color: #64748b; text-decoration: none; }
          section { margin-top: 1rem; }
          h3 { font-weight: 600; color: #1f2937; margin-bottom: 0.5rem; padding-bottom: 0.25rem; border-bottom: 2px solid #06b6d4; }
          ...
          .company, .institution { color: #06b6d4; font-weight: 500; }
          ...
          .tech-tag { background: #8b5cf6; color: white; padding: 0.1rem 0.3rem; border-radius: 2px; }
          .project-links { margin-top: 0.25rem; margin-bottom: 0.25rem; }
          .project-links a { color: #06b6d4; text-decoration: none; margin-right: 0.6rem; }
          ...
          .cert-link a { color: #06b6d4; text-decoration: none; }
          .language-item { display: flex; justify-content: space-between; margin-bottom: 0.25rem; }
          .language-name { color: #1f2937; }
          .language-level { color: #6b7280; text-transform: capitalize; }
          .custom-field { margin-bottom: 0.5rem; }
          ...
          html: `<article class="resume classic-traditional" itemscope itemtype="http://schema.org/Person">
            ...
            <section class="projects">
              ...
              <div class="project-entry">
                ...
                {{#if githubUrl}}<div class="project-links secondaryFont"><div class="github-label">GitHub:</div> <a href="{{githubUrl}}" target="_blank">{{githubUrl}}</a></div>{{/if}}
              </div>
              {{/each}}
            </section>
            {{/if}}
    ...
    // PROFESSIONAL CATEGORY
    {
        ...
        section { margin-bottom: 6px; }
        h2 { font-weight: 600; color: #1e40af; margin-bottom: 6px; padding-bottom: 8px; border-bottom: 2px solid #e5e7eb; position: relative; }
        ...
        @media print { .sidebar { background: white; border: 1px solid #e5e7eb; } }
        .sidebar h2 { color: #1f2937; border-bottom: 1px solid #e5e7eb; margin-bottom: 6px; }
        ...
        templateCode: {
          html: `<div class="resume professional-executive">
            ...
            <div class="executive-bottom">
              ...
              {{#if certifications}}<section class="certifications-section"><h2 class="primaryFont">PROFESSIONAL CERTIFICATIONS</h2><div class="certifications-grid">{{#each certifications}}<div class="certification-item"><h3 class="cert-name primaryFont">{{name}}</h3><div class="cert-issuer secondaryFont">{{issuer}}</div>{{#if date}}<div class="cert-dates secondaryFont">{{formatDate date}}</div>{{/if}}{{#if expiryDate}}<div class="cert-expiry secondaryFont">Expires: {{formatDate expiryDate}}</div>{{/if}}{{#if credentialId}}<div class="cert-id secondaryFont">ID: {{credentialId}}</div>{{/if}}{{#if url}}<div class="cert-link secondaryFont"><a href="{{url}}" target="_blank">Verify</a></div>{{/if}}</div>{{/each}}</div>{{/if}}
            </div>
          ...
          .contact-item a { color: white; text-decoration: none; }
          section { margin-bottom: 6px; }
          section h2 { font-weight: 700; color: #1e3a8a; text-transform: uppercase; margin-bottom: 6px; padding-bottom: 8px; border-bottom: 2px solid #1e3a8a; letter-spacing: 0.5px; }
      ...
      // ACADEMIC CATEGORY
    {
        ...
        .name { font-family: 'Georgia', serif; font-weight: 600; color: #059669; margin-bottom: 6px; letter-spacing: 0.5px; }
        ...
        .edu-entry h3, .position-entry h3, .publication-entry h3, .cert-entry h3, .achievement-title { font-weight: 400; color: #1f2937; margin-bottom: 1px; }
        .institution-info { color: #6b7280; font-style: italic; }
        .edu-dates, .position-dates, .cert-dates, .achievement-date { color: #9ca3af; font-weight: 500; }
        .gpa { color: #6b7280; margin-bottom: 2px; }
        ...
        .skill-category h3 { font-weight: 400; color: #1f2937; margin-bottom: 2px; }
        ...
        .language-name { color: #1f2937; font-weight: 500; }
        .language-level { color: #6b7280; text-transform: capitalize; }
        /* General list styling for HTML content in descriptions */
    ...
    templateCode: {
      ...
      css: `.resume.sleek-professional { font-family: 'Arial', sans-serif; max-width: 8.5in; margin: 0 auto; padding: 0.5in 0.35in; background: white; color: #1e293b; line-height: 1.4; display: grid; grid-template-columns: 2fr 1fr; gap: 20px; }
      ...
      .contact-info { display: flex; flex-wrap: wrap; justify-content: center; gap: 12px; color: #475569; }
      .contact-item { color: #1e293b; }
      .contact-item a { color: #475569; text-decoration: none; }
      .contact-item a:hover { text-decoration: underline; }
      section { margin-bottom: 15px; }
      h3 { font-weight: 600; color: #0f172a; margin-bottom: 8px; padding-bottom: 3px; border-bottom: 1px solid #e2e8f0; text-transform: uppercase; letter-spacing: 0.5px; }
      ...
      .project-name { font-weight: 600; color: #1e293b; margin-bottom: 3px; }
...

  {
    ...
    templateCode: {
      ...
      css: `.resume.dark-mode-dev { font-family: 'Arial', sans-serif; max-width: 8.5in; margin: 0 auto; padding: 0.5in 0.35in; background: white; color: #1f2937; line-height: 1.4; display: grid; grid-template-columns: 2fr 1fr; gap: 20px; }
      ...
      .contact-info { display: flex; flex-wrap: wrap; justify-content: center; gap: 10px; color: #a855f7; }
...

  {
    ...
    templateCode: {
      ...
      .institution, .location, .company, .issuer, .gpa, .dates, .job-dates, .edu-dates, .project-dates, .achievement-date, .cert-dates, .cert-expiry, .cert-id, .achievement-issuer, .cert-issuer { color: #9ca3af; }
      .language-name, .skill-category-title, .job-title, .edu-degree, .project-name, .achievement-title, .cert-name, .custom-field-title { font-weight: bold; color: #1f2937; }
      .project-links a, .cert-link a, .contact-item a { color: #4b5563; text-decoration: none; }
      .project-links a:hover, .cert-link a:hover, .contact-item a:hover { text-decoration: underline; }`
    },
    creator: null,
...

  {
    ...
    "templateCode": {
            ...
            <section>
              ...
              {{#each projects}}
                <div class="project">
                  ...
                  {{#if description}}<div class="description secondaryFont">{{{description}}}</div>{{/if}}
                  {{#if technologies}}<div class="tech secondaryFont">{{#each technologies}}<span class="tech-tag secondaryFont">{{this}}</span>{{/each}}</div>{{/if}}
      ...
      `,
      "css": ".resume.fresh-gradient { font-family: 'Arial', sans-serif; background: #ffffff; color: #111827; padding: 0.5in 0.35in; line-height: 1.4; } .header { margin-bottom: 8px; } .name { margin: 0 0 6px; color: #3b82f6; } .contact-info { display: flex; gap: 10px; color: #3b82f6; } .contact-item a { color: #111827; text-decoration: none; } section { margin-top: 10px; background: transparent; } .job, .edu, .project { background: transparent; } h2 { color: #3b82f6; margin: 0 0 6px; } .section-card { background: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px; padding: 10px; } .project-header { display: flex; justify-content: space-between; } .tech-tag { background: linear-gradient(90deg, #3b82f6, #9333ea); color: white; padding: 2px 5px; border-radius: 6px; margin-right: 3px; } ul, ol { margin: 4px 0; padding-left: 1rem; } ul li, ol li { margin-bottom: 2px; color: #4b5563; line-height: 1.3; } ul { list-style-type: disc; } ol { list-style-type: decimal; } .institution, .location, .company, .issuer, .gpa, .dates, .job-dates, .edu-dates, .project-dates, .achievement-date, .cert-dates, .cert-expiry, .cert-id, .achievement-issuer, .cert-issuer { color: #6b7280; } .language-name, .skill-category-title, .job-title, .edu-degree, .project-name, .achievement-title, .cert-name, .custom-field-title { font-weight: bold; color: #1f2937; } .project-links a, .cert-link a, .contact-item a { color: #374151; text-decoration: none; } .project-links a:hover, .cert-link a:hover, .contact-item a:hover { text-decoration: underline; }"
    },
    creator: null,
